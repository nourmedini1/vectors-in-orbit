...
from user_profiler.kafka_broker import broker

PRODUCTS = [
    {"id": "prod_asus_rog", "name": "ASUS ROG Strix G16", "price": 3200.0, "currency": "TND", "category": "Laptops", "image": "https://images.unsplash.com/photo-1603302576837-37561b2e2302", "description": "High performance gaming laptop with RTX 4060."},
    {"id": "prod_nike_air", "name": "Nike Air Max 90", "price": 450.0, "currency": "TND", "category": "Footwear", "image": "https://images.unsplash.com/photo-1542291026-7eec264c27ff", "description": "Classic comfort and style."},
    {"id": "prod_sony_xm5", "name": "Sony WH-1000XM5", "price": 1200.0, "currency": "TND", "category": "Audio", "image": "https://images.unsplash.com/photo-1618366712010-f4ae9c647dcb", "description": "Noise cancelling headphones."}
]
